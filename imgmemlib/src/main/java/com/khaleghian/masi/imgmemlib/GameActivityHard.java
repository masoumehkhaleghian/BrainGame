...
public class GameActivityHard extends AppCompatActivity {
    ...
    //timer
     ...
     private static final long START_TIME_IN_MILLIS=240000;//4 min
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences per=getSharedPreferences("Data",MODE_PRIVATE);
        record=per.getString("hardImgMem","0");
        //timer
        ...
        //lan
        String lan=LocaleHelper.getLanguage(GameActivityHard.this);
        String sh_language=per.getString("language",lan);
        context= LocaleHelper.setLocale(GameActivityHard.this, sh_language);
        resources = context.getResources();
        //end lan

        //FAB
        game=findViewById(R.id.floatingActionButtongame3);
        what=findViewById(R.id.floatingActionButtonwhat3);
        pause=findViewById(R.id.floatingActionButtonPause3);
        ...
        linearLayouts[5]=findViewById(R.id.linearLayout6);
                ...
                if (image1.equals(image2))
                {
                    ...
                    if (isolate.size()==18)
                    {
                        if (Integer.parseInt(record)<counterSelectMatchImg)
                        {
                            ...
                            SharedPreferences per=getSharedPreferences("Data",MODE_PRIVATE);
                            per.edit().putString("hardImgMem",record).apply();
                        }
                        ...
                        minutes=3-minutes;
                        seconds=59-seconds;
                        //Toast.makeText(GameActivityHard.this, "You Win! And Your Choice Is "+CounterOfChoice, Toast.LENGTH_LONG).show();
    ...
    private void showExitDialog() {
        dialogbox=true;
        pauseTimer();
        final Dialog dialog = new Dialog(GameActivityHard.this);
    ...
    public void showDialog(String sate) {
        ...
        playAgainButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                restartActivity(GameActivityHard.this);
            }
        });
    }
