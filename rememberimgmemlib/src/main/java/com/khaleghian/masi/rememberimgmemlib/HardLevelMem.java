...
public class HardLevelMem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_level_mem5);
        ...
        //FAB
        game=findViewById(R.id.floatingActionButtongame6);
        what=findViewById(R.id.floatingActionButtonwhat6);
        pause=findViewById(R.id.floatingActionButtonPause6);
        ...
        SharedPreferences per=getSharedPreferences("Data",MODE_PRIVATE);
        record=per.getString("hardRemImgMem","0");

        //lan
        String lan=LocaleHelper.getLanguage(HardLevelMem.this);
        String sh_language=per.getString("language",lan);
        context= LocaleHelper.setLocale(HardLevelMem.this, sh_language);
        ...
        linearLayouts[4] = findViewById(R.id.linearLayout5);
    ...
    View.OnClickListener imageButtonListener=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (fileName.equals(img_show_Q.getTag()) && heart>=0) {
                ...
                txt_correct_answer.setText(counter_correct_answer + "/15");
                Toast toast=Toast.makeText(HardLevelMem.this, resources.getString(R.string.correct), Toast.LENGTH_SHORT);
                toast.getView().setBackgroundResource(R.layout.toast_background_color1);
                toast.show();
                if (sound)
                    soundPool.play(match, 1, 1, 0, 0, 1);
                if (counter_correct_answer == 15) {
                    if (Integer.parseInt(record)<counter_correct_answer)
                    {
                        record=String.valueOf(counter_correct_answer);
                        SharedPreferences per=getSharedPreferences("Data",MODE_PRIVATE);
                        per.edit().putString("hardRemImgMem",record).apply();
                    }
                    String mes=(" "+resources.getString(R.string.record)+" "+record);
                    showDialog(resources.getString(R.string.win)+" "+counter_correct_answer+"/15"+mes);
                    if (sound)
            ...
            else
            {
                ...
                Toast toast=Toast.makeText(HardLevelMem.this, resources.getString(R.string.incorrect), Toast.LENGTH_SHORT);
                toast.getView().setBackgroundResource(R.layout.toast_background_color1);
                toast.show();
                if (heart>0)
                {
                ...
                else
                {
                    ...
                    String mes=(" "+resources.getString(R.string.record)+" "+record);
                    showDialog(resources.getString(R.string.lose)+" "+counter_correct_answer+"/15"+mes);
                    if (sound)
    ...
    public void showImageOfEachButton(final ImageButton imageButton, final Boolean bool) {
        try {
    ...
    private void showExitDialog() {
        ...
        final Dialog dialog = new Dialog(HardLevelMem.this);
    ...
    public void showDialog(String sate) {
        ...
        playAgainButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                restartActivity(HardLevelMem.this);
            }
        });
    }
