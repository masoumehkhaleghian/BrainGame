...
public class EasyLevelMem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_level_mem5);
        ...
        SharedPreferences per=getSharedPreferences("Data",MODE_PRIVATE);
        record=per.getString("easyRemImgMem","0");

        //lan
        String lan=LocaleHelper.getLanguage(EasyLevelMem.this);
        String sh_language=per.getString("language",lan);
        context= LocaleHelper.setLocale(EasyLevelMem.this, sh_language);
        ...
        //FAB
        game=findViewById(R.id.floatingActionButtongame5);
        what=findViewById(R.id.floatingActionButtonwhat5);
        pause=findViewById(R.id.floatingActionButtonPause5);
        ...
        linearLayouts[2] = findViewById(R.id.linearLayout4);
        disableButton();
    ...
    View.OnClickListener imageButtonListener=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (fileName.equals(img_show_Q.getTag()) && heart>=0)
            {
                ...
                txt_correct_answer.setText(counter_correct_answer+"/5");
                Toast toast=Toast.makeText(EasyLevelMem.this, resources.getString(R.string.correct), Toast.LENGTH_SHORT);
                toast.getView().setBackgroundResource(R.layout.toast_background_color1);
                toast.show();
                if (sound)
                    soundPool.play(match,1,1,0,0,1);
                if (counter_correct_answer==5)
                {
                    if (Integer.parseInt(record)<counter_correct_answer)
                    {
                        record=String.valueOf(counter_correct_answer);
                        SharedPreferences per=getSharedPreferences("Data",MODE_PRIVATE);
                        per.edit().putString("easyRemImgMem",record).apply();
                    }
                    String mes=(" "+resources.getString(R.string.record)+" "+record);
                    showDialog(resources.getString(R.string.win)+" "+counter_correct_answer+"/5"+mes);
                    if (sound)
            ...
            else
            {
                ...
                Toast toast=Toast.makeText(EasyLevelMem.this, resources.getString(R.string.incorrect), Toast.LENGTH_SHORT);
                toast.getView().setBackgroundResource(R.layout.toast_background_color1);
                toast.show();
                if (heart>0)
                {
                ...
                else
                {
                    ...
                    String mes=(" "+resources.getString(R.string.record)+" "+record);
                    showDialog(resources.getString(R.string.lose)+" "+counter_correct_answer+"/5"+mes);
                    if (sound)
    ...
    private void showExitDialog() {
        ...
        final Dialog dialog = new Dialog(EasyLevelMem.this);
    ...
    public void showDialog(String sate) {
        ...
        playAgainButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                restartActivity(EasyLevelMem.this);
            }
        });
    }
